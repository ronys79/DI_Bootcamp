...
class App:
    ...
    def __init__(self, converter):
        ...
        # self.image1 = Image.open("images/bg1.jpg")
        # self.img_copy= self.image1.copy()
        # self.background_image = ImageTk.PhotoImage(self.image1)
        # self.background = Label(self.bio_frame, image=self.background_image)
        # self.background.pack(fill=BOTH, expand=YES)
...
if __name__ == '__main__':
    # If site isnt working it could be the fre ekey ran out and have to make a newone
