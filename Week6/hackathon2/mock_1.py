...
tabControl.pack(pady=5)

# Create Two Frames
currency_frame = Frame(tabControl, width=480, height=480)
conversion_frame = Frame(tabControl, width=480, height=480)

currency_frame.pack(fill="both", expand=1)
conversion_frame.pack(fill="both", expand=1)

# Add our Tabs
tabControl.add(currency_frame, text="Currencies")
tabControl.add(conversion_frame, text="Convert")
